...
const styles = StyleSheet.create({
  ...
  resetText: { fontFamily: fonts.bold, fontSize: 16, color: colors.purpleText },
  ...
  value: { fontFamily: fonts.regular, fontSize: 16, color: colors.muted },
  valueOn: { fontFamily: fonts.bold, color: colors.purpleText },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, paddingBottom: 16 },
  chip: { backgroundColor: colors.background, borderRadius: 30, paddingHorizontal: 14, minHeight: 44, justifyContent: 'center' },
