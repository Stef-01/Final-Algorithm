...
const styles = StyleSheet.create({
  ...
  cardRole: { fontFamily: fonts.regular, fontSize: 14, color: colors.muted, marginTop: 2, textAlign: 'center' },
  ...
  expandText: { fontFamily: fonts.bold, fontSize: 14, color: colors.black },
  ...
  stepTitle: { fontFamily: fonts.bold, fontSize: 16, color: colors.black },
  ...
  fill: { flex: 1 },
  left: { textAlign: 'left' },
  slot: { fontFamily: fonts.bold, fontSize: 14, color: colors.purpleText, marginTop: 3 },
