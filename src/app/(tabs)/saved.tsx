...
const styles = StyleSheet.create({
  ...
  step: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14, paddingVertical: 12, borderTopWidth: 1, borderTopColor: colors.background },
  when: { width: 78 },
  ...
  stepMain: { flex: 1, minHeight: 44, justifyContent: 'center' },
