...
const styles = StyleSheet.create({
  ...
  content: { padding: 16 },
  lead: { fontFamily: fonts.regular, fontSize: 16, lineHeight: 21, color: colors.black },
  ...
  problem: { fontFamily: fonts.bold, fontSize: 14, color: colors.black, marginTop: 6 },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  pill: { minWidth: 56, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 30, paddingHorizontal: 14, backgroundColor: colors.white },
  pillOn: { backgroundColor: colors.purple },
  ...
  triLabel: { flex: 1, fontFamily: fonts.medium, fontSize: 16, color: colors.black },
