    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.scrim}>
      ...
      <Appear distance={40} style={[styles.card, { paddingBottom: insets.bottom + 12, marginTop: insets.top + 60 }]}>
        ...
        <Text style={styles.fine}>
          ...
          {speech.supported ? ' Voice uses your browser’s speech service.' : ''}
        </Text>
      </Appear>
...
const styles = StyleSheet.create({
  ...
  action: { marginTop: 8, alignSelf: 'flex-start', backgroundColor: colors.background, borderRadius: 30, paddingHorizontal: 14, paddingVertical: 13 },
  ...
  chip: { backgroundColor: colors.background, borderRadius: 30, paddingHorizontal: 14, paddingVertical: 13 },
  ...
  mic: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.background, alignItems: 'center', justifyContent: 'center' },
