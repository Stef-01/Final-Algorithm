...
const styles = StyleSheet.create({
  ...
  action: { marginTop: 8, alignSelf: 'flex-start', borderWidth: 1, borderColor: colors.black, borderRadius: 30, paddingHorizontal: 14, paddingVertical: 13 },
  ...
  chip: { borderWidth: 1, borderColor: colors.black, borderRadius: 30, paddingHorizontal: 14, paddingVertical: 13 },
