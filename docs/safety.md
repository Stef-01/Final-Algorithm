...
- **The assistant never overclaims.** Replies are built from what actually changed. It says "No one fits once I add …" instead of silently emptying the list, and carries a "doesn't give medical advice" line.
