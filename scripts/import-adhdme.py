...
EXPERTISE = {
    ...
    'yuri-lima': [
        ('Injury recovery', 'particular', 'Orthopaedic and sports rehabilitation', 'Yuri does orthopaedic and sports rehabilitation.'),
        ('Return to sport', 'particular', 'Orthopaedic and sports rehabilitation', 'Yuri does orthopaedic and sports rehabilitation.'),
    ],
    'tom-hissey': [
        ('Injury recovery', 'particular', 'Occupational rehabilitation and musculoskeletal physiotherapy',
    ...
    'lester-rafanan': [
        ('Injury recovery', 'particular', 'Injury and surgery recovery, chronic pain, return to sport and NDIS supports',
        ...
        ('Chronic pain', 'particular', 'Injury and surgery recovery, chronic pain, return to sport and NDIS supports',
         'Lester helps with injury and surgery recovery, chronic pain and return to sport.'),
        ('Return to sport', 'general', 'Injury and surgery recovery, chronic pain, return to sport and NDIS supports',
         'Lester helps with injury and surgery recovery, chronic pain and return to sport.'),
